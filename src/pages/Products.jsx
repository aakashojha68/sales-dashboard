  ...
  return (
    <div>
      <div className="dashboard-card flex flex-col items-center justify-center py-20">
        <div className="w-20 h-20 rounded-2xl bg-linear-to-br from-[#05CD99]/10 to-info/10 flex items-center justify-center mb-6">
          <MdInventory className="text-4xl text-[#05CD99]" />
        </div>
        <h2 className="text-xl font-bold text-text-primary mb-2">Products</h2>
