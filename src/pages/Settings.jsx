  ...
  return (
    <div>
      <div className="dashboard-card flex flex-col items-center justify-center py-20">
        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#A3AED0]/10 to-[#2B3674]/10 flex items-center justify-center mb-6">
          <MdSettings className="text-4xl text-[#A3AED0]" />
        </div>
